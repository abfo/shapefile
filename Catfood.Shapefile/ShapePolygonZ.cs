...
{
    /// <summary>A Shapefile PolygonZ shape with optional measures.</summary>
    public class ShapePolygonZ : ShapePolygonM
    {
        /// <summary>Creates a Shapefile PolygonZ shape from a record.</summary>
        ...
        private ShapePolygonZ(int recordNumber, StringDictionary metadata, IDataRecord dataRecord, ShapeRecordData data)
            : base(ShapeType.PolygonZ, recordNumber, metadata, dataRecord, data)
        {
            Zmin = data.Zmin;
            Zmax = data.Zmax;
            Z = data.Z;
